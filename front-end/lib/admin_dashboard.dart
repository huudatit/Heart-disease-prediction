...
class _AdminDashboardState extends State<AdminDashboard> {
    ...
    FirebaseFirestore.instance.collection('users').snapshots().listen((snapshot) {
      if (mounted) {
        setState(() {
          ...
          _maleUsers = snapshot.docs.where((doc) => 
            (doc.data() as Map<String, dynamic>)['gender'] == 'Male' ||
            (doc.data() as Map<String, dynamic>)['gender'] == 'Nam'
          ).length;
          _femaleUsers = snapshot.docs.where((doc) => 
            (doc.data() as Map<String, dynamic>)['gender'] == 'Female' ||
  ...
  Future<void> _logout() async {
    ...
    if (shouldLogout == true) {
      ...
      await prefs.remove('userRole'); // Thêm dòng này để xóa role đã lưu
                              ...
                              child: ListTile(
                                ...
                                subtitle: Column(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        Icon(
                                          user['gender'] == 'Male' || user['gender'] == 'Nam'
                                              ? Icons.male
                                              : Icons.female,
                                          size: 14,
                                          color: Colors.grey[600],
                                ...
                                onTap: () {
                                  Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                      builder: (_) => UserDetailScreen(userId: users[index].id, userData: user),
                                    ),
                                  );
                                },
                              ),
